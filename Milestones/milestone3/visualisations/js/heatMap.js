...
function renderLineChart(data, pointsSystem, championship, roundMetadata) {
    ...
    const lineChartMargin = { top: 50, right: 80, bottom: 50, left: 50 };
    const lineChartWidth = 1100 - lineChartMargin.left - lineChartMargin.right;
...
function updateTop3(data, pointsSystem, championship) {
    ...
    sortedEntities.forEach((entity, index) => {
        top3Container.append('div')
            ...
            .style('margin', '0 20px')
            .html(`<div class="points" style="font-size: 32px; font-weight: bold;">${totalPoints[entity]} pts</div>
                   <div style="font-size: 18px;">${entity}</div>`);
    });
}